...
public class Tetromino {
    ...
    public void checkRotationCollision() {
        ...
        // Check frame-to-rotation collision
        // Left Wall
        for (int i = 0; i < b.length; i++) {
    ...
    public void update() {
        ...
        if (KeyHandler.downPressed) {
            // if the Tetromino's bottom is not hitting, it can go down
    ...
    private void deactivating() {
        ...
        // Wait some frames until deactivating
        if (deactivationCounter == 20) {
            deactivationCounter = 0;
            checkMovementCollision(); // Check if the bottom is still hitting

            // If it is hitting after those frames, deactivate the Tetromino
            if (bottomCollision) {
                active = false;
            }
        }
